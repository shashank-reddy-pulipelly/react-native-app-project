...
function RenderDish(props) {
    ...
    const panResponder = PanResponder.create({
        ...
        onPanResponderGrant: () => {viewRef.rubberBand(1000).then(endState =>
        ...
        if (dish != null) {
            return(
                <Animatable.View animation="fadeInDown"  ref={(ref) => {

                    viewRef=ref;
                    
                    }}
                {...panResponder.panHandlers} duration={2000} delay={1000}>
                <Card featuredTitle={dish.name} image={{uri: baseUrl+dish.image}}>
                    ...
                    <View style={styles.formRow}>
                      <Icon raised reverse name={props.favorite?'heart':'heart-o'}
                       type='font-awesome' color='#f50' onPress={() => props.favorite ?
                         console.log('Already favorite') : props.onPress()}/>
