  ...
  function History(){
    return(
      ...
      <Text style={{margin: 10}}>Started in 2010, Ristorante con Fusion quickly
          ...
          cuisine that can be found nowhere else, it enjoys patronage
          from the A-list clientele in Hong Kong. 
          Featuring four of the best three-star Michelin
          chefs in the world, you never know what will arrive
          on your plate the next time you visit us.</Text>
